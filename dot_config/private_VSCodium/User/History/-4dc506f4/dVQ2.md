...
registry.fedoraproject.org/fedora  43             88b3c09e717d  34 hours ago       373 MB
registry.fedoraproject.org/fedora  42             dca85314b3bf  35 hours ago       170 MB
localhost/laravel                  latest         d7fb7fc3d97f  42 hours ago       407 MB
localhost/mariadb                  latest         0319a1b33b8d  46 hours ago       445 MB
docker.io/library/mariadb          latest         85aad53d41c7  12 days ago        341 MB
docker.io/library/ubuntu           24.04          493218ed0f40  2 weeks ago        161 MB
docker.io/library/debian           bookworm-slim  d60e93accd5d  2 weeks ago        77.9 MB
...
## He realizado los pasos para portar una imagen

He asignado el nombre *restored* al container recuperado

```bash
podman ps -a

e13695ae7658  localhost/mi_app_migracion:latest     /bin/bash             28 minutes ago  Up About a minute               0.0.0.0:8000->8000/tcp  restored
...
Este proceso es más delicado o complicado, por lo que prefiero indicar al contenedor, los volumenes
que preciso la persistencia.
