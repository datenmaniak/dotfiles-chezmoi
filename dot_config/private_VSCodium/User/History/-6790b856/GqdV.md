...
```bash
➜ bakdir
usage: bakdir [-s] [-l] [-b] [-i] [--ignore] [-h] [destino]

USO: ./backup.py ORIGEN [OPCIÓN] [DESTINO] -s Estadísticas -l Listar -i Exclusiones -b DESTINO Backup → DESTINO --ignore Aplica exclusiones
